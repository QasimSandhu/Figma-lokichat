...
class UpdateUserNameResourceResource extends ApiResponse_1.default {
    constructor(data, error = "Invalid email or password", status = 200) {
        if (!data) {
            ...
            const formattedData = Array.isArray(data)
                ? data.map(formatData)
                : formatData(data);
            super(ApiResponse_1.default.success(formattedData, "Username updated successfully", status));
        }
    }
}
...
exports.default = UpdateUserNameResourceResource;
//# sourceMappingURL=UpdateUserNameResource.js.map