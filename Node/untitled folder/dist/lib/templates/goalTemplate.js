...
<head>
	...
	<title>Loki Chat | Email Goal management</title>
...
<body style="margin: 0; font-family: 'Inter', sans-serif;">
	<div style="overflow: auto; position: relative; background: #ececec;">
		<div class="rt-emailtemplatesection" style="max-width: 37.5rem; margin: 0.5rem auto; padding: 22px 32px; background: url(https://lokichatdev.blob.core.windows.net/loki-templates/bg.png) no-repeat; background-size: cover;  overflow: hidden; width: 100%; position: relative;">
			...
			<div class="rt-templatecontent" style="width: 100%; padding:33px 28px; margin-bottom: 16px; background-color: #FFFFFF;  border-radius: 12px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box;">
				<div style="width: 100%; text-align: left;">
					<h1 class="rt-headingtext" style="margin: 0; font-size: 1.625rem; line-height: 1.3; font-weight: 700; color: #0a0c17;text-align:left">Goal Management</h1>
					<p class="rt-paragraphtext" style="margin: 0; font-size: 1.125rem; font-weight: 400; line-height: 1.5; color: #6C7275; padding-top: 1.5rem;">We understand that as a student, setting and achieving your <span style="color: #0084FF;">goals</span> is a vital part of your academic journey and personal development.</p>
					<p class="rt-paragraphtext" style="margin: 0; font-size: 1.125rem; font-weight: 400; line-height: 1.5; color: #6C7275; padding-top: 1.5rem;">If you have any questions or concerns, don’t hesitate to reach out to our team.</p>
        ...
        <div class="rt-templatecontent" style="width: 100%; padding:33px 28px; margin-bottom: 16px; background-color: #FFFFFF;  border-radius: 12px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box;">
            <div style="width: 100%; text-align: left;">
                <h1 class="rt-headingtext" style="margin: 0; font-size: 1.625rem; line-height: 1.3; font-weight: 700; color: #0a0c17;text-align:left">Time: ${time}</h1>
                <p class="rt-paragraphtext" style="margin: 0; font-size: 1.125rem; font-weight: 400; line-height: 1.5; color: #6C7275; padding-top: 1.5rem;">Make sure to complete the task before so you don’t miss anything and can submit your goal on time.</p>               
            </div>
    </div>
...
//# sourceMappingURL=goalTemplate.js.map