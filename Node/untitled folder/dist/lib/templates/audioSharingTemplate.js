...
const template = () => {
    ...
    <head>
        ...
        <title>Loki Chat | Email Audio Share</title>
            ...
            <div class="rt-emailtemplatesection" style="max-width: 37.5rem; margin: 0.5rem auto; padding: 22px 32px; background: url(https://lokichatdev.blob.core.windows.net/loki-templates/bg.png) no-repeat; background-size: cover;  overflow: hidden; width: 100%; position: relative;">
                ...
                <div class="rt-templatecontent" style="width: 100%; padding:33px 28px; margin-bottom: 16px; background-color: #FFFFFF;  border-radius: 12px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box;">
                    <div style="width: 100%; text-align: left;">
                        <h1 class="rt-headingtext" style="margin: 0; font-size: 1.625rem; line-height: 1.3; font-weight: 700; color: #0a0c17;text-align:left">Audio Sharing</h1>
                        <p class="rt-paragraphtext" style="margin: 0; font-size: 1.25rem; font-weight: 500; line-height: 1.5; color:#0084FF; padding-top: 1.5rem;">Share Your Audio - Let Your Voice Be Heard</p>
                        <p class="rt-paragraphtext" style="margin: 0; font-size: 1.125rem; font-weight: 400; line-height: 1.5; color: #6C7275; padding-top: 1rem;">Exciting news! Someone has shared an audio clip with you through our app, <span style="font-weight: 500; color: #0a0c17;">Loki Chat</span> , and you're just a click away from listening to it.</p>
                        <p class="rt-paragraphtext" style="margin: 0; font-size: 1.125rem; font-weight: 400; line-height: 1.5; color: #6C7275; padding-top: 2.5rem;">Click on the button that will direct you to the platform where you can listen the audios.</p>
                    </div>
                    <a href="javascript:void(0);" style="text-decoration: none;">
                        <div class="bdebate-btn" style="padding: 13px 10px; width: 235px; background-color: #1A90FF;border: 1px solid transparent; text-align: center; border-radius: 8px; color: white; font-size: 16px;margin-top: 40px;">
                            Listen Audio
                        </div>
                        </a>
            </div>	
...
//# sourceMappingURL=audioSharingTemplate.js.map