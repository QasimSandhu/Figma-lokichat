...
const template = (name, topic, time, date, avatar = 'https://lokichatdev.blob.core.windows.net/images/refferal-management/02.png') => {
    return `
    <!doctype html>
<html>
<head>
...
//# sourceMappingURL=debateRequestTemplate.js.map