...
<head>
	...
	<title>Loki Chat | Email Debate request approved</title>
		...
		<div class="rt-emailtemplatesection" style="max-width: 37.5rem; margin: 0.5rem auto; padding: 22px 32px; background: url(https://lokichatdev.blob.core.windows.net/loki-templates/bg.png) no-repeat; background-size: cover;  overflow: hidden; width: 100%; position: relative;">
			...
			<div class="rt-templatecontent" style="width: 100%; padding:33px 28px; margin-bottom: 16px; background-color: #FFFFFF;  border-radius: 12px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box;">
				<div style="width: 100%; text-align: left;">
					<h1 class="rt-headingtext" style="margin: 0; font-size: 1.625rem; line-height: 1.3; font-weight: 700; color: #0a0c17;text-align:left">Debate Request <span style="display: block;">Approved</span></h1>
					<p class="rt-paragraphtext" style="margin: 0; font-size: 1.125rem; font-weight: 400; line-height: 1.5; color: #6C7275; padding-top: 1.5rem;">I am delighted to inform you that your debate request has been officially approved. We're excited to have you as an integral part of our upcoming debate.</p>
					<p class="rt-paragraphtext" style="margin: 0; font-size: 1.125rem; font-weight: 400; line-height: 1.5; color: #6C7275; padding-top: 1.5rem;">Do you want to start the Debate?</p>
                </div>
                <div class="debate-buttons" style="width: 100%;margin-top: 42px;">
                    <a href="javascript:void(0);" style="text-decoration: none;">
                        <div class="bdebate-btn" style="padding: 13px 10px; width: 44%; background-color :white; border: 1px solid #6C7275; text-align: center; border-radius: 8px; color: #6C7275; font-size: 16px; display: inline-block; vertical-align: middle;">
                            Cancel Debate
                        </div>
                        </a>
                        <a href="javascript:void(0);" style="text-decoration: none;">
                            <div class="bdebate-btn" style="padding: 13px 10px; width: 44%; background-color: #1A90FF;border: 1px solid transparent; text-align: center; border-radius: 8px; color: white; font-size: 16px; display: inline-block; vertical-align: middle; margin-left: 8px;">
                                Start Debate
                            </div>
                            </a>
...
//# sourceMappingURL=debateApprovedTemplate.js.map