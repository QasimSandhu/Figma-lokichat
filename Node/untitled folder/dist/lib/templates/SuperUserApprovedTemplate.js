...
<head>
	...
	<title>Loki Chat | Email Super user request approved</title>
...
<body style="margin: 0; font-family: 'Inter', sans-serif;">
	<div style="overflow: auto; position: relative; background: #ececec;">
		<div class="rt-emailtemplatesection" style="max-width: 37.5rem; margin: 0.5rem auto; padding: 22px 32px; background: url(https://lokichatdev.blob.core.windows.net/loki-templates/bg.png) no-repeat; background-size: cover;  overflow: hidden; width: 100%; position: relative;">
			...
			<div class="rt-templatecontent" style="width: 100%; padding:33px 28px; margin-bottom: 16px; background-color: #FFFFFF;  border-radius: 12px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box;">
				<div style="width: 100%; text-align: left;">
					<h1 class="rt-headingtext" style="margin: 0; font-size: 1.625rem; line-height: 1.3; font-weight: 700; color: #0a0c17;text-align:left">Super User Request Approved</h1>
					...
					<p class="rt-paragraphtext" style="margin: 0; font-size: 1.125rem; font-weight: 400; line-height: 1.5; color: #6C7275; padding-top: 1.5rem;">We are thrilled to inform you that your Super User request has been officially approved. Congratulations! We are excited to welcome you as a valuable member of our Super User team.</p>
        ...
        <div class="rt-templatecontent" style="width: 100%; padding:33px 28px; margin-bottom: 16px; background-color: #FFFFFF;  border-radius: 12px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box;">
            <div style="width: 100%; text-align: left;">
                <h1 class="rt-headingtext" style="margin: 0; font-size: 1.625rem; line-height: 1.3; font-weight: 700; color: #0a0c17;text-align:left">Your Role as a Super User:</h1>
                <p class="rt-paragraphtext" style="margin: 0; font-size: 1.125rem; font-weight: 400; line-height: 1.5; color: #6C7275; padding-top: 1.5rem;">As a Super User, you will play a crucial role in our community. By switching to super user you can create campaign and earn commission.</p>
                <a href="javascript:void(0);" style="vertical-align: left;text-decoration: none;">
                    <div style="padding: 13px 42px; background-color: #1A90FF; text-align: center;vertical-align: middle;display: inline-block; border-radius: 8px; color: white; font-size: 16px; margin-top: 32px;">
                        Create Campaign
                    </div>
                    </a>
            </div>
...
//# sourceMappingURL=SuperUserApprovedTemplate.js.map