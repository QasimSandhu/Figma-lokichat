...
const DocumentTranslationService_1 = __importDefault(require("../services/DocumentTranslationService"));
...
class DocumentTranslationController {
    store(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, requestHelper_1.handleRequest)(req, res, null, DocumentTranslationService_1.default.store, HandleTranslationResource_1.default);
        });
    }
    show(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.default = new DocumentTranslationController();
//# sourceMappingURL=DocumentTranslationController.js.map