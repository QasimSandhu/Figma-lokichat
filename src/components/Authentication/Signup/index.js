                            ...
                            <Form>
                                <Form.Group controlId="formBasicEmail">
                                    <div className="input-group mt-3">
                                        ...
                                        <Form.Control
                                            ...
                                            className='border-start-0 signup-input-field'
                                        />
                                    </div>
                                </Form.Group>
                                ...
                                <Form.Group controlId="formBasicEmail">
                                    <div className="input-group mt-2">
                                        <span className="input-group-text align-items-center" style={{ background: '#D9D9D9', width: '30px' }}><i className="bi bi-lock"></i></span>
                                        <Form.Control
                                            type="email"
                                ...
                                <Button as={Link} to={'/'} className='mt-5 col-lg-12 bg-color-lightskyblue' type="submit">Create my account</Button>
                            </Form>
                        </div>
                    </Col>
                </Col>
